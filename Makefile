...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Thu Mar 31 13:56:02 2011
...
SOURCES       = src/addressbookcontroller.cpp \
		...
		src/qteditcontactdialog.cpp src/tmp/moc_qtaddcontactdialog.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) src/tmp/address-book1.0.0/ && $(COPY_FILE) --parents src/addressbookcontroller.h src/addressbookmodel.h src/addressbookview.h src/contact.h src/dummydatasource.h src/errorinfo.h src/qtaddcontactdialog.h src/qtaddressbookgui.h src/qtcontactdetailview.h src/qtcontactform.h src/qtcontactlist.h src/qteditcontactdialog.h src/tmp/address-book1.0.0/ && $(COPY_FILE) --parents src/addressbookcontroller.cpp src/contact.cpp src/dummydatasource.cpp src/main.cpp src/qtaddcontactdialog.cpp src/qtaddressbookgui.cpp src/qtcontactdetailview.cpp src/qtcontactform.cpp src/qtcontactlist.cpp src/qteditcontactdialog.cpp src/tmp/address-book1.0.0/ && (cd `dirname src/tmp/address-book1.0.0` && $(TAR) address-book1.0.0.tar address-book1.0.0 && $(COMPRESS) address-book1.0.0.tar) && $(MOVE) `dirname src/tmp/address-book1.0.0`/address-book1.0.0.tar.gz . && $(DEL_FILE) -r src/tmp/address-book1.0.0
...
compiler_moc_header_make_all: src/tmp/moc_qtaddcontactdialog.cpp src/tmp/moc_qtaddressbookgui.cpp src/tmp/moc_qtcontactdetailview.cpp src/tmp/moc_qtcontactform.cpp src/tmp/moc_qtcontactlist.cpp src/tmp/moc_qteditcontactdialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) src/tmp/moc_qtaddcontactdialog.cpp src/tmp/moc_qtaddressbookgui.cpp src/tmp/moc_qtcontactdetailview.cpp src/tmp/moc_qtcontactform.cpp src/tmp/moc_qtcontactlist.cpp src/tmp/moc_qteditcontactdialog.cpp
